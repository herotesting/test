...
router.use(function(req, res, next)
{
	...
	res.on('finish', function()
	{
		...
		console.log('---> method: ' + req.method + ' (at SITEMAP.JS file) - url: ' + req.url + ' - done in: ' + duration + 'ms \n');
...
router.get('/', function(req, res) // to jest ('/') tak naprawde adres http://localhost:6500/sitemap
{
	...
	*/
	...
	res.render('sitemap'); // nie musimy podawac rozszerzenia pliku - .ejs
	//res.end();
	//next();
});
